...
def test_check_permissions_without_sudo():
...
def test_parse_system_profiler_data_success():
    """Test parsing system profiler data successfully."""
    test_data = {
        'SPHardwareDataType': [
            {
                'model_name': 'MacBook Pro',
                'processor_name': 'Apple M2 Max'
            }
        ]
    }
